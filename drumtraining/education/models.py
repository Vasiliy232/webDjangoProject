...
class Course(models.Model):
    ...
    img = models.ImageField(upload_to='course', blank=True, null=True)
    category = models.ForeignKey('Category', null=True, default=None, on_delete=models.PROTECT)
...
class Category(models.Model):
    ...
    def get_course_count(self):
        courses = Course.objects.filter(category=self).select_related('category')
